...
export default function Footer() {
  return (
    <footer className="grid grid-cols-12 bg-themeYellow py-4 fixed bottom-0">
      <div className="col-span-10 col-start-2 content-center grid grid-cols-subgrid pt-[4rem]">
        <div className="col-span-10 md:col-span-5 flex flex-col">
          <Link
            href={"/"}
            className="text-center text-6xl text-darkBlue py-4 md:text-7xl uppercase font-extrabold"
          >
            josiegal
          </Link>
        ...
        <div className="col-span-10 text-xl font-black md:col-span-5 md:content-center">
          <div className="flex flex-row flex-wrap justify-center mx-auto py-8">
            ...
            <Link
              className="w-2/5 flex justify-end pb-4 md:justify-start"
            ...
            <Link
              ...
              className="w-2/5 text-end pb-4 hover:underline md:text-start"
            >
              josie58@live.cn
            </Link>

            <h4 className="w-2/5 pb-4">Base in</h4>
            <div className="w-2/5 text-end pb-4 md:text-start">Falkirk, UK</div>
            <h4 className="w-2/5 pb-4">Download cv</h4>
            <div className="w-2/5 text-end pb-4 md:text-start">a link</div>
          </div>
        </div>
      </div>
